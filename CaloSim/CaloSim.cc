...
int main(int argc,char** argv)
{
  ...
  G4VUserPrimaryGeneratorAction* gen_action = new CaloSimPrimaryGeneratorAction(CaloSimDetector);
...
// get the pointer to the UI manager and set verbosities
 ...
 if (argc!=1)   // batch mode  
  ...
  G4Colour transp = G4Colour(1,1,1,0);
  ...
  traj->Set("mu-", "yellow");
  traj->Set("nu_e", "grey");
  traj->Set("anti_nu_e", "grey");
  traj->Set("nu_mu", "grey");
  traj->Set("anti_nu_mu", "grey");
