...
CaloSimPrimaryGeneratorMessenger::CaloSimPrimaryGeneratorMessenger(CaloSimPrimaryGeneratorAction* myGun) : myAction(myGun)
{ 
  ...
  UseFileCmd->SetGuidance("Set boolean flag for using input file (zero = no, 1 = yes)");
...
void CaloSimPrimaryGeneratorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{ 
