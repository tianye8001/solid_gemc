...
// Mon Apr 26 11:34:44 2010 by ROOT version 5.18/00
// from TTree ntuple/ROOT Ntuple for G4 data
// found on file: far.root
//////////////////////////////////////////////////////////
...
#ifdef aclass_cxx
aclass::aclass(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("far.root");
      if (!f) {
         f = new TFile("far.root");
      }
...
Int_t aclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t aclass::LoadTree(Long64_t entry)
{
...
void aclass::Show(Long64_t entry)
{
...
Int_t aclass::Cut(Long64_t entry)
{
