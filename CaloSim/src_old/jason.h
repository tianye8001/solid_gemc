...
// Mon May 24 10:46:49 2010 by ROOT version 5.18/00
// from TTree ntuple/ROOT Ntuple for G4 data
// found on file: single.root
//////////////////////////////////////////////////////////
...
#ifdef jason_cxx
jason::jason(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("single.root");
      if (!f) {
         f = new TFile("single.root");
      }
...
Int_t jason::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jason::LoadTree(Long64_t entry)
{
...
void jason::Show(Long64_t entry)
{
...
Int_t jason::Cut(Long64_t entry)
{
