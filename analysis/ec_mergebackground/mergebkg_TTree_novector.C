...
void mergebkg_TTree()
{
  ...
  TFile *f3=new TFile("/work/halla/solid/sim/solid_gemc/SIDIS_He3_JLAB_VERSION_1.3/pass7/background_solid_SIDIS_He3_dirty_normalized_pi0HallD_filenum500_5e6.root");
  TFile *f4=new TFile("/work/halla/solid/sim/solid_gemc/SIDIS_He3_JLAB_VERSION_1.3/pass7/background_solid_SIDIS_He3_dirty_normalized_pipHallD_filenum500_5e6.root");
  ...
  TFile *f2 = new TFile("mergetree_SIDIS_allpions_total_all2.root", "RECREATE");
