...
#run simulation
solid_gemc solid_SIDIS_gem_virtualplane.gcard -BEAM_P="proton,5.5*GeV,15*deg,0*deg" -SPREAD_P="5.5*GeV,15*deg,180*deg" -BEAM_V="(0,0,-350)cm" -SPREAD_V="(0.0,20)cm" -OUTPUT=evio,gem_sidis_he3_vp.evio -N=1e5

#convert evio to root
#which  evio2root
evio2root -INPUTF=gem_sidis_he3_vp.evio -R="flux" 
