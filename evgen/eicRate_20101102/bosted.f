...
c funtion emcfit_PB. Fit to "EMC effect" used to 
...
!--------------------------------------------------------------------
      ...
      double precision a4, x4, emcfit_PB, emcfac
      logical goodfit
      INTEGER ISM
...
cc        if(W .GT. 1.3) 
     ...
     >        (1.0+P(13)*x+P(14)*x**2+P(15)*x**3+P(16)*x**4+P(17)*x**5)
      ...
      A4 = A
      x4 = qsq / 2. / pm / nu
      emcfac = emcfit_PB(x4, a4, goodfit)
...
!---------------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION emcfit_PB(X,A,GOODFIT)       
!---------------------------------------------------------------------  
