...
void getrate(TString particle,int hadron_flag){
	//particle: pion    kaon
	...
	for(Long64_t i=0;i<N_entries;i++){
		...
		if(Q2>=1&&mom_ele>1.0 && mom_ele<10.0 && W>=2.3 && Wp>=1.6 && z>0.3 && z<0.7){ //zhihong's cut
			...
			if(mom_ele>=1.0&&theta_ele/3.14159265*180.0>=8.0
					&&theta_had/3.14159265*180.0>=8.0){
				rate_forward+=event_weight*forward_acceptance;
			}
			if(mom_ele>=3.5&&theta_ele/3.14159265*180.0>=8.0
					&&theta_had/3.14159265*180.0>=8.0){
