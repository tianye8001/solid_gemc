...
TH2F *hBr = new TH2F("Br","Br",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hBz = new TH2F("Bz","Bz",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hB = new TH2F("B","B",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hdBzdr = new TH2F("dBzdr","dBz/dz",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hdBrdz = new TH2F("dBrdz","dBr/dz",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hFI = new TH2F("Field Index","Field Index",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hBperp = new TH2F("Bperp","B perpendicular to path",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
