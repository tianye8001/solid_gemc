...
# $configuration{"detector_name"} = "solid_SIDIS_target_NH3_block";
...
#Geometry definition
require "solid_SIDIS_target_NH3_block_geometry.pl";
solid_SIDIS_target_NH3_block();

# materials definition 
require "./solid_target_NH3_block_materials.pl";
