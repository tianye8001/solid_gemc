...
my $rmin_chamber=2197.345;  # r position of the chamber entrance at large angle according to survey, sqrt(8.4369^2+1.09^2)=850.7
...
my $hz3	= 56*2.54/2+4.5+8.5+6.12+5.62+6.89+5.12+40.64/2;
