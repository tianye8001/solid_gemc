...
sub make_detector_CERV
{
 ...
 my $phiTotal    = 360;
 my $numZPlanes  = 4;
 $detector{"dimensions"}  = "$phiStart*deg $phiTotal*deg $numZPlanes 61.0*cm 70.3*cm 70.3*cm 96.0*cm 142*cm 162*cm 260*cm 260*cm -0.04*cm 24.0*cm 24.0*cm 90.1*cm";
