...
sub make_target_PVDIS_beampipe1_entrance
{
 ...
 my @Dz   = (150.,150.,0.1);
 my @name = ("BMP1","BMV1","BMD1"); 
 my @mother=("","_BMP1","_BMV1");
 my @mat  = ("Aluminum","Vacuum","Vacuum");
...
sub make_target_PVDIS_beampipe4_exit
{
 ...
 my @mother=("","_BMP4","_BMV4");
 my @mat  = ("Aluminum","Vacuum","Iron");
...
{
 my $NUM  = 6;
 my @z    = (0.,0.,-24.975,24.975,0.,0.);
 my @Rin  = (0.,0.,0.,0.,0.,0.);
 my @Rout = (5.,4.95,1.22,1.5,1.918,1.9);
 my @Dz   = (25.,24.95,0.025,0.025,20.,19.982);
 my @name = ("TACH","TACV","TAV1","TAW2","TALU","TAH2"); 
 my @mother=("","_TACH","_TACH","_TACH","_TACV","_TALU");
