...
my $DetectorName = 'BaBar_SIDIS_solenoid';
...
# C
# GPARVOL30  'SOLE'    0  'HALL'    0.    0.  350.    0  'TUBE'  3  1. 1. 1.
# GPARVOL31  'CRYO'  296  'SOLE'    0.    0.    0.    0  'TUBE'  3  142. 177.  192.5
# GPARVOL32  'CRYV'  203  'CRYO'    0.    0.    0.    0  'TUBE'  3  147. 172.  187.5
# GPARVOL33  'SCL1'  235  'CRYV'    0.    0.    0.    0  'TUBE'  3  152. 154.  175.0
...
sub make_detector_coil
{
 ...
 my @Rin  = (142.,147.,152.);
 my @Rout = (177.,172.,154.);
 my @Dz   = (192.5,192.5,175.);
 my @name = ("CRYO","CRYV","SCL1");
 my @mother = ("","_coil_CRYO","_coil_CRYV");
 my @mat  = ("Iron","Air","Aluminum");
 my @color= ("003333","ff8000","ffffff");

 for(my $n=1; $n<=$NUM; $n++)
 {
#     my $pnumber     = cnumber($n-1, 10);
    $detector{"name"}        = "$DetectorName\_coil_$name[$n-1]";
    $detector{"mother"}      = "$DetectorName$mother[$n-1]";
    $detector{"description"} = $detector{"name"};
    $detector{"pos"}        = "0*cm 0*cm 0*cm";
    $detector{"rotation"}   = "0*deg 0*deg 0*deg";
...
#PVDIS and SIDIS have same yoke
...
# C
# GPARVOL51  'SYD1'  296  'SOLE'    0.    0.    0.    0  'PCON'  18 0.  360. 5. 
#             192.5 210.0 240.0  197.5 188.0 240.0  197.5 152.0 240.0  207.0 152.0 240.0  222. 166.0 188.0
# GPARVOL52  'SYD2'  296  'SOLE'    0.    0.    0.    0  'PCON'  15 0.  360. 4. 
...
#PVDIS and SIDIS have different SYD3 and SYD4 for yoke_downstream
...
#PVDIS and SIDIS have same yoke_upstream
