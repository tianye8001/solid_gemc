...
my $DetectorName = 'BaBar_PVDIS_solenoid';
...
#SIDIS made SYD3 60cm larger; SDY4 unchange size, but shifted
...
sub make_solenoid_yoke_downstream4
{
 ...
 my $phiTotal    = 360;
 my $numZPlanes  = 6;
 $detector{"dimensions"}  = "$phiStart*deg $phiTotal*deg $numZPlanes 22.0*cm 30.0*cm 30.0*cm 30.0*cm 30.0*cm 30.0*cm 58.0*cm 89.0*cm 128.0*cm 290.0*cm 290.0*cm 120.0*cm 200.0*cm 280.0*cm 380.0*cm 380.0*cm 400.0*cm 420.0*cm";
 $detector{"material"}    = "Iron";
 $detector{"mfield"}      = "no";
 $detector{"ncopy"}       = 1;
 $detector{"pMany"}       = 1;
