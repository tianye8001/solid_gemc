...
#  (including no material) and sensitivities

#  Usage: solid_gem.pl -nsectors=n -activeangle=a -material=m -sens=s
...
#  * 22   NEMA G10 120 um
  ...
  # unit in mm
	...
	("no",  #  HoneyComb NEMA G10 120 um
	 ...
	 "no")  #  Honeycomb NEMA G10 120 um
	:
	("SBSGEM",  #  HoneyComb NEMA G10 120 um
	 "SBSGEM",  #  HoneyComb SBSGEMMEX    3um
	 "SBSGEM",  #  HoneyComb NEMA G10 120 um
	 "SBSGEM",  #  Drift Cathode Kapton 50 um
	 "SBSGEM",  #  Drift Cathode Copper 5 um
	 "SBSGEM",  #  Drift Cathode Gas 3 mm
	 "SBSGEM",  #  GEM0 Copper 5 um
	 "SBSGEM",  #  GEM0 Kapton 50 um
	 "SBSGEM",  #  GEM0 Copper 5 um
	 "SBSGEM",  #  GEM0 Gas 2 mm
	 "SBSGEM",  #  GEM1 Copper 5 um
	 "SBSGEM",  #  GEM1 Kapton 50 um
	 "SBSGEM",  #  GEM1 Copper 5 um
	 "SBSGEM",  #  GEM1 Gas 2 mm
	 "SBSGEM",  #  GEM2 Copper 5 um
	 "SBSGEM",  #  GEM2 Kapton 50 um
	 "SBSGEM",  #  GEM2 Copper 5 um
	 "SBSGEM",  #  GEM2 Gas 2 mm 
	 "SBSGEM",  #  Readout Board Copper 10 um
	 "SBSGEM",  #  Readout Board Kapton 50 um
	 "SBSGEM",  #  Honeycomb NEMA G10 120 um
	 "SBSGEM",  #  Honeycomb SBSGEMMEX   3um
	 "SBSGEM");  #  Honeycomb NEMA G10 120 um
    my @hitt = $SENS == 1 ? 
