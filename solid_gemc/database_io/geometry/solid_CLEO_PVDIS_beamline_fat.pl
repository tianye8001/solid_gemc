...
my $DetectorName = 'CLEO_PVDIS_beamline_fat';
...
# note adjusted thickness to 500 um
 my @Rmin1  = (0.,0.,0.,0.);
# my @Rmax1 = (1.5,1.4,139.9,1.4);
 my @Rmax1 = (1.5,1.45,139.95,1.45);
 my @Rmin2  = (0.,0.,0.,0.);
# my @Rmax2 = (140.,139.9,139.9,1.4);
 my @Rmax2 = (140.,139.95,139.95,1.45);
 ...
 my @mat  = ("Aluminum","Vacuum","Vacuum","G4_Be");
# my @mat  = ("Kryptonite","Vacuum","Vacuum","G4_Be");
