...
#     $detector{"dimensions"} = "$Rin[$n-1]*cm $Rout[$n-1]*cm $Dz[$n-1]*cm 0*deg 360*deg";
    ...
    if ($n==1) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 2*cm 2*cm -675*cm -375*cm";}
    if ($n==2) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 1.95*cm 1.95*cm -675*cm -375*cm";}
    if ($n==3) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 1.95*cm 1.95*cm -675*cm -674.9*cm";}
    if ($n==4) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 1.95*cm 1.95*cm -375.01*cm -375*cm";}
...
#     $detector{"dimensions"} = "$Rmin1[$n-1]*cm $Rmax1[$n-1]*cm $Rmin2[$n-1]*cm $Rmax2[$n-1]*cm $Dz[$n-1]*cm 0*deg 360*deg";
    $detector{"type"}       = "Polycone";
    if ($n==1) {$detector{"dimensions"} = "0*deg 360*deg 3 0*cm 0*cm 0*cm 1.05*cm 19*cm 19*cm -325*cm 190*cm 550*cm";}
    if ($n==2) {$detector{"dimensions"} = "0*deg 360*deg 3 0*cm 0*cm 0*cm 1.*cm 18.95*cm 18.95*cm -325*cm 190*cm 550*cm";}
    if ($n==3) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 18.95*cm 18.95*cm 549.9*cm 550*cm";}
    if ($n==4) {$detector{"dimensions"} = "0*deg 360*deg 2 0*cm 0*cm 1.*cm 1.*cm -325*cm -324.99*cm";}
    $detector{"material"}   = $mat[$n-1];
    $detector{"mfield"}     = "no";
    $detector{"ncopy"}      = $n;
    $detector{"pMany"}       = 1;
