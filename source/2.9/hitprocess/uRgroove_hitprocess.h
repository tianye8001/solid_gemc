#ifndef uRgroove_HITPROCESS_H
#define uRgroove_HITPROCESS_H 1
...
/// \class uRgroove_HitProcess
/// <b> FMT_HitProcess </b>\n\n
/// The uRGroove hit process routine is initially copied from the working uRWell process and uses the same strip-helper structure:\n
...
class uRgroove_HitProcess : public HitProcess
{
public:
	...
	static HitProcess *createHitClass() {return new uRgroove_HitProcess;}
	
private:
	
	// constants initialized with initWithRunNumber
	static uRgrooveConstants uRgrooveC;
