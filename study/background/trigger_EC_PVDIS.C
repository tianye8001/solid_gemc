...
//trig file more1
// file_trig_cut[0]=new TFile("triggerfile/Lead2X0PbBlock_Hex.1.PVDIS_RunALL_GetEfficiencies_Full_bgd_BackGround_Sept2013_Real_Eklog_R_high_R0_ALL.rootTriggerSummaryhigh.root");
// file_trig_cut[1]=new TFile("triggerfile/Lead2X0PbBlock_Hex.1.PVDIS_RunALL_GetEfficiencies_Full_bgd_BackGround_Sept2013_Real_Eklog_R_low_R0_ALL.rootTriggerSummarylow.root");

//trig file more1 block
file_trig_cut[0]=new TFile("triggerfile/Lead2X0PbBlock_Hex.1.PVDIS_RunALL_GetEfficiencies_Full_bgd_BackGround_Sept2013_Block_Real_Eklog_R_high_R0_ALL.rootTriggerSummaryhigh.root");
file_trig_cut[1]=new TFile("triggerfile/Lead2X0PbBlock_Hex.1.PVDIS_RunALL_GetEfficiencies_Full_bgd_BackGround_Sept2013_Block_Real_Eklog_R_low_R0_ALL.rootTriggerSummarylow.root");
