...
#include "../../../solid/solid_gemc2/analysis/analysis_tree_solid_spd.C"
#include "../../../solid/solid_gemc2/analysis/analysis_tree_solid_mrpc.C"
#include "../../../solid/solid_gemc2/analysis/analysis_tree_solid_ec.C"
