...
acceptance_solid_CLEO_SIDIS_He3_negative_output.root
*/
...
//			T->Add(Form("./sidis_3he_km_%d_0_2_0.root",ele_energy));   // save Q2<10, pt<1
    ...
    //CLEO	
	TFile *file_negative=new TFile("./acceptance/acceptance_solid_CLEO_SIDIS_He3_negative_output.root");
	...
	for(Long64_t i=0;i<N_entries;i++){
		...
		if(mom_ele>=1.0&&mom_ele<=10.0&&W>=2.3&&Wp>=1.6&&z>0.3&&z<0.7&&mom_had<=2.5){//any additional cuts should be added in here
			...
			//mandatary energy threshold cut on ECs
			if(mom_ele>1.)
