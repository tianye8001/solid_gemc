...
$configuration{"detector_name"} = "UVatest_gem";
$configuration{"variation"} = "Original";

# To get the parameters proper authentication is needed.
# our %parameters    = get_parameters(%configuration);
# $configuration{"detector_name"} = "UVatest";

#Geometry definition
require "UVatest_gem_geometry.pl";
UVatest_gem_geometry();
require "UVatest_gem_virtualplane.pl";
UVatest_gem_virtualplane();
