...
vector<int> *solid_gem_id=0,*solid_gem_hitn=0;
vector<int> *solid_gem_pid=0,*solid_gem_trid=0;
vector<double> *solid_gem_x=0,*solid_gem_y=0,*solid_gem_z=0,*solid_gem_lxin=0,*solid_gem_lyin=0,*solid_gem_lzin=0,*solid_gem_tin=0,*solid_gem_lxout=0,*solid_gem_lyout=0,*solid_gem_lzout=0,*solid_gem_tout=0,*solid_gem_px=0,*solid_gem_py=0,*solid_gem_pz=0,*solid_gem_vx=0,*solid_gem_vy=0,*solid_gem_vz=0,*solid_gem_ETot=0,*solid_gem_trE=0,*solid_gem_weight=0;
...
//     cout << detector_ID << " " << subdetector_ID << " "  << subsubdetector_ID << endl;  
    ...
    cout << solid_gem_hitn->size() << endl;
    for (Int_t j=0;j<solid_gem_hitn->size();j++) {     
