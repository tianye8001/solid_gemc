...
my $Dz   = 15.511/2;  #unit in mm
my @layer_thickness = (0.005,0.02,3,0.05,0.003,3,0.003,0.05,0.003,2,0.003,0.05,0.003,2,0.003,0.05,0.003,2,0.01,0.05,0.18,3,0.02,0.005);  # unit in mm
my @material =
