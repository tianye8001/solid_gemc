...
$configuration{"detector_name"} = "solid_ccprototype";
...
#Geometry definition
require "solid_ccprototype_geometry.pl";
solid_ccprototype_geometry();
require "solid_ccprototype_virtualplane.pl";
solid_ccprototype_virtualplane();

#materials
require "solid_ccprototype_materials.pl";

#mirror
require "solid_ccprototype_mirror.pl";
