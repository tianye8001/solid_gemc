...
// GEANT4 tag $Name: geant4-9-4-patch-02 $
// Developer: Chao Peng
//
...
{ 
  public:
    ...
    CalorimeterParameterisation( G4int    NoPMT,
                                 G4int    NoPMTline, 
 				 G4double widthCalor, 
...
/*    
    void ComputeDimensions (G4Box & CalBlock, const G4int copyNo,
...
*/
  private:
    ...
    G4int    fNoPMTline;   
    G4double fspacingXY;
    G4ThreeVector fCenterPos; 
//    G4Transform3D fCenterPos;
    G4double fsizeX;     
    G4double fsizeY;     
};
