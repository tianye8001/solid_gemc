...
//
//
// $Id: cherPhysicsListMessenger.cc,v 1.3 2006/06/29 17:54:25 gunter Exp $
...
#include "cherPhysicsListMessenger.hh"
...
cherPhysicsListMessenger::cherPhysicsListMessenger(cherPhysicsList* pPhys)
:pPhysicsList(pPhys)
{
...
cherPhysicsListMessenger::~cherPhysicsListMessenger()
{
  delete verboseCmd;
  delete cerenkovCmd;
  delete physDir;
...
void cherPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{       
