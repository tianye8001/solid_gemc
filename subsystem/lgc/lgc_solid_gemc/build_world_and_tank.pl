...
sub make_mother
{
    ...
    $detector{"description"} = "SoLID container";
    $detector{"pos"}         = "0*cm 0*cm 0*cm";
    $detector{"rotation"}    = "0*deg 0*deg 0*deg";
    $detector{"color"}       = "ff0000";
    $detector{"type"}        = "Tube";
#    $detector{"dimensions"}  = "0.0*cm 500.0*cm 800*cm 0*deg 360*deg";
    $detector{"dimensions"}  = "0.0*cm 500.0*m 800*m 0*deg 360*deg";
...
{
    my %detector=init_det();
    $detector{"name"}        = "emptyV";
    $detector{"mother"}      = $detMom;
    $detector{"description"} = "SoLID empty container";
    $detector{"pos"}         = "0*m 0*m -200.0*m";
    $detector{"rotation"}    = "0*deg 0*deg 0*deg";
    $detector{"color"}       = "ff0000";
    $detector{"type"}        = "Tube";
#    $detector{"dimensions"}  = "0.0*cm 500.0*cm 606*cm 0*deg 360*deg";
    $detector{"dimensions"}  = "0.0*m 400.0*m 201.931*m 0*deg 360*deg";
    $detector{"material"}    = "Vacuum";
    $detector{"mfield"}      = "no";
    $detector{"ncopy"}       = 1;
    $detector{"pMany"}       = 1;
...
sub make_tank_CLEO_sidis
{
    ...
    $detector{"color"}       = "FF9900";
    $detector{"type"}        = "Polycone";
   # $detector{"dimensions"}  = "0*deg 360*deg 2*counts 58*cm 71*cm 127*cm 144*cm 97*cm 194*cm";
...
sub  make_tank_CLEO_sidis_front_window
{
#front window:
