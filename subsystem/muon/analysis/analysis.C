...
TH1F *htotEdep_hgc=new TH1F("htotEdep_hgc","ec;totEdep(MeV);",100,900,1600);
...
// TCanvas *c = new TCanvas("totEdep_hgc","totEdep_hgc",1600,900);
// htotEdep_hgc->Draw();
// htotEdep_hgc->Fit("gaus");
// c->SaveAs("totEdep_hgc.png");
